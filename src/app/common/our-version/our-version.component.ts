...
// import { OurMissionComponent, OurMissionComponent } from '../our-mission/our-mission.component';
import { RouterLink } from '@angular/router';
import { OurMissionComponent } from '../our-mission/our-mission.component';
import { ThemeCustomizerService } from '../theme-customizer/theme-customizer.service';

@Component({
    selector: 'app-our-version',
    standalone: true,
    imports: [
    ...
    templateUrl: './our-version.component.html',
    styleUrl: './our-version.component.scss',
})
export class OurVersionComponent {
    isToggled = false;
