...
@Component({
    selector: 'app-header-style-zero',
    standalone: true,
    imports: [
    ...
    templateUrl: './header-style-zero.component.html',
    styleUrl: './header-style-zero.component.scss',
})
export class HeaderStyleZeroComponent {
    isToggled = false;
